...
class Event(db.Model):
    ...
    Constraints:
        - `id`, `title`, `description`, `location`, `start_date`, `end_date`, `start_time`, `end_time`, `thumbnail`, and `creator_id` cannot be null.
    ...
    id = db.Column(db.String(36), default=str(uuid.uuid4()), primary_key=True, unique=True, nullable=False)
