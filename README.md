...
For detailed documentation on these API endpoints and their usage, please refer to the [API DOCUMENTATION.md](Huricane-event-backend/API_DOCUMENTATION.md) file.
